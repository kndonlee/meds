...
class MedDash
  ...
  def reset_meds
    ...
    @meds[:baclofen]       = Med.new(name: :baclofen,       interval:8,  required:48, default_dose:7.5,  half_life:4*3600,     max_dose:0,     dose_units: :mg,   display:true,  display_log:false, emoji:"26A1")
