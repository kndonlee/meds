...
class MedDash
  ...
  def reset_meds
    ...
    @meds[:choline]        = Med.new(name: :choline,        interval:8,    required:8,  default_dose:6.25, half_life:10*3600,    max_dose:0,     dose_units: :mg,   display: :on_dose,  display_log:false, announce:false,  emoji:"1F971")
