...
class MedDash
  ...
  def reset_meds
    ...
    @meds[:biotin]         = Med.new(name: :biotin,         interval:2,    required:2,   default_dose:1,   half_life:3600,      max_dose:0,     dose_units: :unit, display: :yes,       display_log:false, announce:false,  emoji:"1F517")
