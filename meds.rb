...
class MedDash
  ...
  def reset_meds
    ...
    #
    @meds = {}
    @meds[:morphine]       = Med.new(name: :morphine,       interval:8,  required:12, default_dose:15,   half_life:3*3600,     max_dose:0,     dose_units: :mg,   display:true,  display_log:true,  emoji:"1F480")
    ...
    @meds[:msm]            = Med.new(name: :msm,            interval:1.75, required:2,default_dose:500,  half_life:48*3600,   max_dose:2000,  dose_units: :mg,   display:true,  display_log:true,  emoji:"1F30B")
