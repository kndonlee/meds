...
class MedDash
  ...
  def reset_meds
    ...
    @meds[:dilauded]       = Med.new(name: :dilauded,       interval:4,    required:5,  default_dose:1,    half_life:2.5*3600,   max_dose:0,     dose_units: :mg,   display: :on_dose,  display_log:true,  announce:false,  emoji:"1F48A")
    ...
    @meds[:periactin]      = Med.new(name: :periactin,      interval:6,    required:8,  default_dose:2,    half_life:7.5*3600,  max_dose:12,    dose_units: :mg,   display: :yes,       display_log:false, announce:false,  emoji:"1F971")
    ...
    @meds[:taurine]        = Med.new(name: :taurine,        interval:3,    required:4,  default_dose:500,  half_life:3600,       max_dose:6500,  dose_units: :mg,   display: :yes,      display_log:true,  announce:false,  emoji:"1F431")
    ...
    @meds[:liver]          = Med.new(name: :liver,          interval:24,   required:48, default_dose:1,    half_life:3600,      max_dose:0,     dose_units: :mg,   display: :yes,       display_log:false, announce:false,  emoji:"1F48A")
    @meds[:marrow]         = Med.new(name: :marrow,         interval:24,   required:48, default_dose:1,    half_life:3600,      max_dose:0,     dose_units: :mg,   display: :yes,       display_log:false, announce:false,  emoji:"1F48A")
    ...
    @meds[:docusate]       = Med.new(name: :docusate,       interval:3,    required:3,  default_dose:100,  half_life:3600,      max_dose:400,   dose_units: :mg,   display: :yes,       display_log:false, announce:false,  emoji:"1F4A9")
