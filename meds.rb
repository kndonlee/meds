...
class MedDash
  ...
  def reset_meds
    ...
    @meds[:docusate]       = Med.new(name: :docusate,       interval:3,    required:3,  default_dose:300,  half_life:3600,      max_dose:100,   dose_units: :mg,   display: :yes,       display_log:false, announce:false,  emoji:"1F4A9")
