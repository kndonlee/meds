...
class MedDash
  ...
  def reset_meds
    ...
    @meds[:propranolol]    = Med.new(name: :propranolol,    interval:4,  required:48, default_dose:80,   half_life:8*3600,     max_dose:0,     dose_units: :mg,   display: :on_dose, display_log:false, emoji:"1F497")
    ...
    @meds[:msm]            = Med.new(name: :msm,            interval:1.75, required:2,default_dose:500,  half_life:8*3600,    max_dose:1500,  dose_units: :mg,   display: :yes,  display_log:true,  emoji:"1F30B")
