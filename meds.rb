...
class MedDash
  ...
  def reset_meds
    ...
    @meds[:docusate]       = Med.new(name: :docusate,       interval:3,    required:3,  default_dose:100,  half_life:3600,      max_dose:300,   dose_units: :mg,   display: :on_dose,   display_log:false, announce:false,  emoji:"1F4A9")
    ...
    @meds[:ubiquinol]      = Med.new(name: :ubiquinol,      interval:23,   required:48, default_dose:50,   half_life:3600,      max_dose:0,     dose_units: :mg,   display: :no,        display_log:false, announce:false,  emoji:"1F4A6")
