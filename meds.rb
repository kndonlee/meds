...
class MedDash
  ...
  def reset_meds
    ...
    @meds[:hd]             = Med.new(name: :hd,             interval:24,   required:24, default_dose:1,    half_life:3600,      max_dose:3,     dose_units: :g,    display: :yes,       display_log:false, announce:false,  emoji:"1F4A6")
