...
class MedDash
  ...
  def reset_meds
    ...
    @meds[:dummy]          = Med.new(name: :dummy,          interval:4,    required:6,  default_dose:25,   half_life:3600,      max_dose:0,     dose_units: :mg,   display: :yes,       display_log:false, announce:false,  emoji:"1F4A6")
