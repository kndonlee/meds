...
class MedDash
  ...
  def reset_meds
    ...
    @meds[:nac]            = Med.new(name: :nac,            interval:23,   required:24, default_dose:500,  half_life:5.6*3600,  max_dose:500,   dose_units: :mg,   display: :yes_awake, display_log:true,  announce:false,  emoji:"26FD")
