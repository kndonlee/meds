...
class MedDash
  ...
  def reset_meds
    ...
    @meds[:hd]             = Med.new(name: :hd,             interval:24,   required:24, default_dose:1,    half_life:3600,      max_dose:1,     dose_units: :g,    display: :yes,       display_log:false, announce:false,  emoji:"1F4A6")
    ...
    @meds[:biotin]         = Med.new(name: :biotin,         interval:2,    required:2,   default_dose:50,  half_life:3600,      max_dose:0,     dose_units: :unit, display: :yes,       display_log:false, announce:false,  emoji:"1F517")
