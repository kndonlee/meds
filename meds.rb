...
class MedDash
  ...
  def reset_meds
    ...
    @meds[:robaxin]        = Med.new(name: :robaxin,        interval:6,  required:48, default_dose:500,  max_dose:0,     dose_units: :mg,   display:true,  display_log:false,  emoji:"26A1")
    ...
    @meds[:propranolol]    = Med.new(name: :propranolol,    interval:12, required:48, default_dose:80,   max_dose:0,     dose_units: :mg,   display:true,  display_log:false, emoji:"1F497")
