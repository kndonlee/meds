...
class MedDash
  ...
  def reset_meds
    ...
    @meds[:phosphatidyl_c] = Med.new(name: :phosphatidyl_c, interval:24, required:48, default_dose:420,  max_dose:0,     dose_units: :mg,   display:true,  display_log:false, emoji:"1F48A")
