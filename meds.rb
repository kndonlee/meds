...
class MedDash
  ...
  def reset_meds
    ...
    @meds[:marrow]         = Med.new(name: :marrow,         interval:24,   required:48, default_dose:1,    half_life:3600,      max_dose:3000,  dose_units: :mg,   display: :yes,       display_log:false, announce:false,  emoji:"1F48A")
